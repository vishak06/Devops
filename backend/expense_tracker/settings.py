...
Supports SQLite (local dev) and PostgreSQL (production/RDS).
"""
...
MIDDLEWARE = [
    ...
    # CSRF disabled for simplicity in this demo API
...
# Database
# Use PostgreSQL if DB_HOST is set (production), else SQLite (local dev)
